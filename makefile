...
my_test: libgtest.a test_case.c linkedlist.c Gtest_main.c makefile
	
	g++ -isystem ${GTEST_DIR}/include -pthread test_case.c linkedlist.c Gtest_main.c libgtest.a -o my_test -g --coverage
